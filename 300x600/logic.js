...
function BuildAfterNoonTemplate(feedData,elements) {
    ...
    */
    ...
    insertCopy(elements.frame3_copy, `TREMFYA<sup>®</sup> is proven to <span class="spanColor">significantly reduce</span> joint pain, stiffness, and swelling`,  feedData[0].frame3_copy_style);
    insertCopy(elements.frame3_copy2, `In two medical studies, at 24 weeks, more than 5 out of 10 TREMFYA<sup>®</sup> patients had at least 20% improvement in active PsA symptoms. <br>Results may vary.`, '');
    ...
    insertImage('https://s0.2mdn.net/ads/richmedia/studio/44660889/44660889_20230927011532432_PsA_300x600_Endemic-Afternoon_Fatigue.jpg',"src", elements.heroImage);
   ...
   //Initial Style for wrapper and main container elements should be set to display none initially.
    ...
    if (feedData[0].Person == "HM") {
        timeline.add([
            ...
            TweenMax.to('#heroImage', 0.8, { alpha: 1, delay: 16.5, zIndex:2, ease: Cubic.easeInOut }), // 12.5
            //Frame 1
            ...
            // //System  graphics
            TweenMax.to('#graphicImg1', 1, { delay: 3, bottom:-22, alpha: 1,  ease: Cubic.easeInOut }),
            TweenMax.to('#graphicImg1', 12.5, { delay: 2.5, rotate:-78, ease: Cubic.easeInOut }),
            ...
            TweenMax.to('#graphicImg1', 1, { delay: 16.3, alpha: 1, bottom:'150%', scale:1.8, ease: Cubic.easeInOut }), // 12.3
            ...
            // //Frame 5
            TweenMax.to('#frame5', 1, { delay: 1, /*y: "+=90",*/ ease: Cubic.easeInOut }),
            TweenMax.to('#frame5', 1, { alpha: 1, delay: 17.3, /*y: "-=90",*/ ease: Cubic.easeInOut }), // 13.3

            // //Cta
            TweenMax.to('#cta', 1, { delay: 1, /*y: "+=90",*/ ease: Cubic.easeInOut }),
            TweenMax.to('#cta', 1, { alpha: 1, delay: 17.3, /*y: "-=90",*/ ease: Cubic.easeInOut }), // 13.3
        ])
    } else {
        timeline.add([
           ...
           // TweenMax.to('#curveBox', 2, { alpha: 1, delay: 2, bottom:700, ease: Cubic.easeInOut }),
            ...
            //System  graphics
            TweenMax.to('#graphicImg1', 1, { delay: 3, bottom:-22, alpha: 1,  ease: Cubic.easeInOut }),
            TweenMax.to('#graphicImg1', 12.5, { delay: 2.5, rotate:6, ease: Cubic.easeInOut }),
            //TweenMax.to('#graphicImg1', 1.5, { delay: 8, rotate:0, ease: Cubic.easeInOut }),
