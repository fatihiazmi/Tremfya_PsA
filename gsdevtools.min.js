...
!(function (e, t) {
    ...
    function oi(e) {
      ...
      if (P) {
        ...
        V
          ...
          : h
          ? (q && ((j.deltaY = u - h.top()), h.top(u)),
            K && ((j.deltaX = p - h.left()), h.left(p)))
          : G
            ...
            ? (N = (function buildPointSnapFunc(l, s, c, d, p, u, g) {
                return (
                  ...
                  X(l)
                    ...
                    ? function (e) {
                        for (
                          var t, o, n, i, r = l.length, a = 0, s = Xe;
                          -1 < --r;
    ...
    function vi(e, t) {
      ...
      e && Se
        ? (!0 === e &&
            ...
            (e = {
              resistance:
                (p.throwResistance || p.resistance || 1e3) / (V ? 10 : 1),
            }),
            V
          ...
          V
            ...
            : (z &&
              ...
              (j.lockAxis || j.lockedAxis) &&
                ...
                ((l = j.lockedAxis) ||
                  ((j.lockedAxis = l =
                    K && Math.abs(n) > Math.abs(i) ? "y" : q ? "x" : null),
                  l &&
                    X(j.vars.onLockAxis) &&
    ...
    return (
      ...
      (e.update = function (e, t, o) {
        ...
        return (
          ...
          j.isPressed &&
            !t &&
            ((K && 0.01 < Math.abs(a - j.x)) ||
              (q && 0.01 < Math.abs(s - j.y) && !V)) &&
            xi(),
          j.autoScroll &&
            (Ja(g.parentNode, j.isDragging),
            (ee = j.isDragging),
            oi(!0),
            Ga(g, Ei),
            Fa(g, Ei)),
      ...
      (e.enable = function (e) {
        ...
        return (
          ...
          Se &&
            "soft" !== e &&
            Se.track(h || g, G ? "x,y" : V ? "rotation" : "top,left"),
          (g._gsDragID = t = "d" + Ye++),
          (Re[t] = j),
      ...
      (e.disable = function (e) {
        ...
        return (
          ...
          Se &&
            "soft" !== e &&
            Se.untrack(h || g, G ? "x,y" : V ? "rotation" : "top,left"),
          h && h.disable(),
          va(oi),
  ...
  function Bb(e, t, o) {
    var n = j.createElementNS
      ? j.createElementNS("svg" === e ? I : F, e)
      : j.createElement(e);
    return (
      t && (rb(t) && (t = j.querySelector(t)), t.appendChild(n)),
      "svg" === e &&
        (n.setAttribute("xmlns", I), n.setAttribute("xmlns:xlink", F)),
      o && (n.style.cssText = o),
      n
    );
  }
    ...
    ue = function GSDevTools(r) {
      ...
      function Oo() {
        ...
        for (
          a && !r.globalSync
            ? o.unshift(a)
            : r.hideGlobalTimeline || o.unshift(Q),
            t = 0;
          t < o.length;
          t++
        )
      ...
      function $o(e) {
        ...
        o && (Mb(X, o, N, o + "x"), v.timeScale(o)),
          100 ===
            (D =
              ("inTime" in r ? Gb(r.inTime, i, 0, 0) : n ? t._inProgress : 0) ||
              0) &&
            !r.animation &&
            t &&
  ...
  (ue.version = "3.10.4"),
    ...
    (ue.getByAnimation = function (e) {
      for (var t in (rb(e) && (e = K.getById(e)), de))
